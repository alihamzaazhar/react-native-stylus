...
export function AnnotationScreen() {
  ...
  return <LabScreen eyebrow="EDITABLE OVERLAY" title="Annotate images and PDF pages">
    ...
    <Card><View style={styles.annotationPage}><Text style={styles.eyebrow}>PDF PAGE {document.target.page}</Text><StylusCanvas style={styles.fill} strokes={document.strokes} fingerDrawingEnabled color="#b54b2a" strokeWidth={8} onStrokesChange={update}/></View></Card>
